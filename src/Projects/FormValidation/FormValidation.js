    ...
    <React.Fragment>
      ...
      <div className="row mb-5">
          <div className="col-sm-6 text-success">
            <h3 className="p-3 fw-bold text-Green"> Contact form validation using React js</h3>
            <p>You cannot Submit without inputing values, Email Input has to be a valid email address or else it gives a warning</p>
             </div>
